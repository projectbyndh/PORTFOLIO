      ...
      <div className="min-h-screen bg-[#FAFAFA] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
          ...
          >
            ...
            <h2 className="text-2xl font-black text-neutral-900 mb-4">Failed to Load Partners</h2>
            <p className="text-neutral-600 mb-8">{error}</p>
            <button
              onClick={handleRetry}
              className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-[#4A8EBC] to-[#3B7AA8] text-white font-bold py-3 px-8 rounded-2xl shadow-[0_0_20px_rgba(74,142,188,0.3)] hover:scale-105 transition-all duration-300 overflow-hidden"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm border border-white/40 rounded-full mb-4 shadow-sm">
                <Building2 size={14} className="text-[#4A8EBC]" />
                <span className="text-xs font-bold uppercase tracking-widest text-neutral-600">Management</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-black text-neutral-900 tracking-tight">
                Partner <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A8EBC] to-[#3B7AA8]">Directory</span>
              </h1>
            ...
            <button
              ...
              className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-[#4A8EBC] to-[#3B7AA8] text-white font-bold py-4 px-8 rounded-2xl shadow-[0_0_30px_rgba(74,142,188,0.4),0_8px_16px_rgba(74,142,188,0.2)] hover:scale-105 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl" />
              ...
              >
                <div className="p-8">
                  <div className="flex justify-between items-center mb-8 pb-6 border-b border-neutral-200">
                    ...
                    <button
                      onClick={handleFormClose}
                      className="p-2 text-neutral-400 hover:text-neutral-900 hover:bg-neutral-100 rounded-xl transition-all duration-200"
                    >
                      <X size={24} />
                    </button>
                  </div>
        ...
        {partners.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-2xl font-black text-neutral-900 mb-4">No Partners Yet</h3>
            <p className="text-neutral-600 mb-8">Start building your partner network by adding your first partner.</p>
            <button
              onClick={() => setShowForm(true)}
              className="inline-flex items-center gap-2 text-[#4A8EBC] font-bold hover:gap-3 transition-all"
            >
              <Plus size={20} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {partners.map((partner, index) => (
              ...
              >
                {/* Hover glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#4A8EBC]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[1.5rem]" />
                ...
                <div className="relative z-10">
                  ...
                  {/* Partner Name */}
                  <h3 className="text-lg font-black text-neutral-900 text-center mb-6 group-hover:text-[#4A8EBC] transition-colors">
                    {partner.name}
                  </h3>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-neutral-100 hover:bg-[#4A8EBC] text-neutral-700 hover:text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 border border-neutral-200 hover:border-[#4A8EBC]"
                    >
                      <Edit2 size={16} />
