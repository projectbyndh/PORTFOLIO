        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-black text-[#26a8df]">Services</h1>
                        <p className="text-[#26a8df]/60 mt-1">Manage your services</p>
                    </div>
                    ...
                    {loading && services.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center py-20">
                            <div className="w-20 h-20 bg-[#F5FAFF] rounded-full flex items-center justify-center mb-4">
                                <PlusCircle className="w-10 h-10 text-[#26a8df]/40" />
                            </div>
                            <p className="text-[#26a8df] font-semibold text-lg mb-2">No services found</p>
                            <p className="text-[#26a8df]/60 mb-6 max-w-sm">List your services to let clients know what you offer.</p>
                            <button
                                onClick={() => setShowForm(true)}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-[#F5FAFF] border-b border-[#26a8df]/10">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-sm font-bold text-[#26a8df] uppercase tracking-wider">Service Name</th>
                                        <th className="px-6 py-4 text-left text-sm font-bold text-[#26a8df] uppercase tracking-wider">Description</th>
                                        <th className="px-6 py-4 text-right text-sm font-bold text-[#26a8df] uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={service._id} className="hover:bg-[#F5FAFF]/50 transition-colors group">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    {service.logo && (
                                                        <div className="w-10 h-10 rounded-lg bg-white border border-[#26a8df]/10 p-1 flex-shrink-0">
                                                            <img
                                                    ...
                                                    <p className="font-semibold text-[#26a8df] group-hover:text-[#26a8df] transition-colors">{service.name || service.title}</p>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 max-w-md">
                                                <p className="text-sm text-[#26a8df]/70 line-clamp-2">{service.description}</p>
                                            </td>
                                            <td className="px-6 py-4">
