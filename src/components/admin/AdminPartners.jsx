        ...
        <AdminLayout>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-black text-[#1A2A44]">Partners</h1>
                        <p className="text-[#2B4066]/60 mt-1">Manage your business partners</p>
                    </div>
                ...
                <div className="bg-white rounded-2xl border border-[#4A8EBC]/10 shadow-sm overflow-hidden min-h-[400px]">
                    {loading && partners.length === 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center py-20">
                            ...
                            <p className="text-[#2B4066] font-semibold text-lg mb-2">No partners found</p>
                            <p className="text-[#2B4066]/60 mb-6 max-w-sm">Get started by adding your first partner to the portfolio.</p>
                            <button
                                onClick={() => setShowForm(true)}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                            {partners.map((partner, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="font-bold text-[#1A2A44] mb-4 group-hover:text-[#4A8EBC] transition-colors">{partner.name}</h3>
