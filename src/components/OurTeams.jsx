    ...
    return (
      <div className="min-h-screen bg-[#FAFAFA] py-12 flex items-center justify-center relative pt-20 md:pt-24 lg:pt-28">
        ...
        <div className="text-center">
          ...
          <button onClick={() => window.location.reload()} className="bg-[#0D1641] text-white font-bold py-2 px-6 rounded-xl transition-all shadow-md">
            Retry
          </button>
        </div>
      </div>
            ...
            {teamData.map((layer, layerIdx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`grid gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-7xl mx-auto ${layer.members.length === 1 ? 'grid-cols-1 max-w-md mx-auto' :
