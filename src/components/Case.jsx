      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-2xl xl:text-3xl font-bold text-white mb-4 sm:mb-5 md:mb-6 lg:mb-5 relative">Ready to improve how your business looks online?</h2>
