...
export default function Careers() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F5FAFF] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        {careers.length === 0 ? (
          <div className="text-center py-20 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg border border-[#4A8EBC]/10">
            <div className="w-24 h-24 bg-gradient-to-br from-[#4A8EBC]/20 to-[#3B5488]/20 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#4A8EBC] to-[#3B5488] text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
                ...
                >
                  ...
                  <div className="aspect-[3/4] w-full">
                    {career.image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-[#4A8EBC] to-[#3B5488] flex items-center justify-center">
                        <Briefcase className="w-20 h-20 text-white/50" />
                      </div>
                    )}
                  </div>
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1A2A44]/80 via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
                  {/* Apply Button */}
      ...
      {/* Why Join Us Section */}
      <div className="w-full bg-gradient-to-t from-[#E0F0FF] to-[#F5FAFF] py-16 px-4 sm:px-6 lg:px-8 relative">
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
            {/* Modal Header */}
            <div className="relative bg-gradient-to-r from-[#4A8EBC] to-[#3B5488] px-8 py-6">
              <button
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-[#4A8EBC] to-[#3B5488] text-white font-bold rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105"
                >
                  Submit Application
                </button>
              </form>
