  ...
  return ( 
    <div className="w-full min-h-screen bg-[#FAFAFA] relative pt-20 md:pt-24 lg:pt-28">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-40 left-10 w-64 h-64 rounded-full bg-[#26a8df]/10 blur-3xl"></div>
        <div className="absolute bottom-40 right-10 w-96 h-96 rounded-full bg-[#26a8df]/10 blur-3xl"></div>
      </div>
      ...
      <div className="w-full bg-gradient-to-b from-white/60 to-[#FAFAFA] py-8 sm:py-10 md:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-block relative">
            <div className="absolute -top-2 sm:-top-3 md:-top-4 -left-2 sm:-left-3 md:-left-4 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-[#26a8df]/20 animate-pulse"></div>
            <div className="absolute -bottom-2 sm:-bottom-3 md:-bottom-4 -right-2 sm:-right-3 md:-right-4 w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-[#26a8df]/20 animate-pulse"></div>
            <span className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-[#26a8df]/10 rounded-full text-[#26a8df] text-xs sm:text-sm font-medium mb-4 sm:mb-5 md:mb-6">
              <Briefcase className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4" />
              We're Hiring!
            </span>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-4 sm:mb-5 md:mb-6 tracking-tight text-[#26a8df]">
            Join Our Tech Revolution at <span className="text-[#26a8df]">NDH Tech!</span>
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-[#26a8df]/80 max-w-3xl mx-auto mb-6 sm:mb-7 md:mb-8 px-4">
            Explore open roles, meet our team, and apply to shape the future with NDH Tech!
          </p>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 text-[#26a8df]/70 text-xs sm:text-sm">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <MapPin className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#26a8df]" />
              Remote & On-site
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <Clock className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#26a8df]" />
              Full-time & Part-time
            </div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              <CheckCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-[#26a8df]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16 relative z-10">
        <div className="text-center mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#26a8df] mb-3 sm:mb-4">
            Open Positions
          </h2>
          <p className="text-sm sm:text-base md:text-lg text-[#26a8df]/80 max-w-2xl mx-auto px-4">
            Explore our current opportunities and find the perfect role for your skills and ambitions.
          </p>
        </div>

        {careers.length === 0 ? (
          <div className="text-center py-12 sm:py-14 md:py-16 lg:py-20 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg border border-[#26a8df]/10">
            {loading ? (
              <div className="flex items-center justify-center py-6 sm:py-8">
                <Loader2 className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 animate-spin text-[#26a8df]" />
                <span className="ml-2 text-[#26a8df] text-sm sm:text-base">Loading careers...</span>
              </div>
            ) : (
              <>
                <div className="w-20 h-20 sm:w-22 sm:h-22 md:w-24 md:h-24 bg-linear-to-br from-[#26a8df]/20 to-[#26a8df]/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-5 md:mb-6">
                  <Briefcase className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 text-[#26a8df]" />
                </div>
                <h3 className="text-xl sm:text-2xl font-semibold text-[#26a8df] mb-2 sm:mb-3">
                  {error ? 'Error Loading Careers' : 'No Openings Right Now'}
                </h3>
                <p className="text-[#26a8df]/80 max-w-md mx-auto mb-6 sm:mb-7 md:mb-8 text-sm sm:text-base px-4">
                  {error
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
              {careers.map((career, index) => (
                <div
                  ...
                  className="group relative rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 bg-white border border-[#26a8df]/10 h-full flex flex-col"
                ...
                >
                  ...
                  <div className="w-full h-48 sm:h-56 md:h-60 lg:h-64 relative overflow-hidden">
                    {career.image ? (
                      ...
                      <div className="w-full h-full bg-linear-to-br from-[#26a8df] to-[#26a8df] flex items-center justify-center">
                  ...
                  <div className="p-4 sm:p-5 md:p-6 bg-white flex-grow flex flex-col">
                    <h3 className="text-base sm:text-lg md:text-xl font-bold text-[#26a8df] mb-1.5 sm:mb-2 line-clamp-2">{career.title}</h3>
                    <div className="flex items-center gap-1.5 sm:gap-2 text-[#26a8df]/70 mb-2 sm:mb-2.5 md:mb-3">
                      <MapPin className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4" />
                      <span className="text-xs sm:text-sm">{career.location}</span>
                    </div>
                    <p className="text-[#26a8df]/80 text-xs sm:text-sm line-clamp-3 mb-3 sm:mb-3.5 md:mb-4 flex-grow">
            ...
            <div className="mt-10 sm:mt-12 md:mt-14 lg:mt-12 text-center">
              <p className="text-[#26a8df]/80 mb-3 sm:mb-4 text-sm sm:text-base px-4">
      ...
      <div className="w-full bg-gradient-to-t from-white/60 to-[#FAFAFA] py-16 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#26a8df] mb-4">
              Why Join NDH Tech?
            </h2>
            <p className="text-lg text-[#26a8df]/80 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center p-8 rounded-xl bg-white/70 backdrop-blur-sm shadow-lg border border-[#26a8df]/10 hover:shadow-xl hover:bg-white/90 transition-all duration-300">
                <div className="text-5xl mb-4">{item.icon}</div>
                <h3 className="text-xl font-bold text-[#26a8df] mb-2">{item.title}</h3>
                <p className="text-[#26a8df]/80">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {showForm && selectedCareer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-[#26a8df]/40 backdrop-blur-md" onClick={handleCloseForm} />

          <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="sticky top-0 z-10 bg-gradient-to-r from-[#26a8df] to-[#26a8df] px-8 py-6">
              <button
