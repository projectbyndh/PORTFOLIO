...
export default function TeamMembers() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center pt-20 md:pt-24 lg:pt-28">
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] relative pt-20 md:pt-24 lg:pt-28 pb-12 sm:pb-16 md:pb-20 lg:pb-24">
      {/* Texture & blobs */}
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 md:p-6 lg:p-8 flex flex-col items-center text-center relative z-10">
        ...
        {member.bio && (
          <p className="text-neutral-600 text-xs sm:text-sm leading-relaxed line-clamp-3 mb-4 sm:mb-5 md:mb-6">
            {member.bio}
          </p>
        )}

        {/* Socials */}
        <div className="mt-auto flex gap-2 sm:gap-2.5 md:gap-3 opacity-80 group-hover:opacity-100 transition-opacity">
          {member.socialLinks?.linkedin && (
            <a href={member.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-neutral-100 hover:bg-[#0077B5] hover:text-white transition-all duration-300 text-neutral-500">
              <Linkedin size={16} className="sm:w-4 sm:h-4 md:w-[18px] md:h-[18px]" />
            </a>
          )}
          {member.socialLinks?.github && (
            <a href={member.socialLinks.github} target="_blank" rel="noopener noreferrer" className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-neutral-100 hover:bg-[#333] hover:text-white transition-all duration-300 text-neutral-500">
              <Github size={16} className="sm:w-4 sm:h-4 md:w-[18px] md:h-[18px]" />
            </a>
          )}
